...
echo '<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
       Actualizar <small>Usuário</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form role="form" enctype="multipart/form-data" action="../../App/Database/insertuser.php" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="username" class="form-control" id="exampleInputEmail1" placeholder="Nome do usuário" value="'.$resp['nomeUsuario'].'">
                </div>
            ...
            echo '<div class="form-group">
                    ...
                    <option value="2" '.$selected2.'>Professor</option>
                    <option value="3" '.$selected3.'>Estudante</option>
                    </select>
                  </div>';
